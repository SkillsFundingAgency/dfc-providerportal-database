...
/****** Object:  Job [TribalDatabaseRestore_job]    Script Date: 7/2/2019 10:13:04 AM ******/
EXEC msdb.dbo.sp_delete_job @job_id=N'29ee5edc-b04c-4988-a1c9-d91a99b8092e', @delete_unused_schedule=1
GO
...
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 7/2/2019 10:13:04 AM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'TribalDatabaseRestore_job', 
		@enabled=1, 
...
', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Restore]    Script Date: 7/2/2019 10:13:05 AM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Sched2', 
		@enabled=1, 
		@freq_type=4, 
		@freq_interval=1, 
		@freq_subday_type=1, 
		...
		@schedule_uid=N'c570f33e-a2e8-4ddd-9e64-c1315831718d'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
